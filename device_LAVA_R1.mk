...
DEVICE_PACKAGE_OVERLAYS += device/Lava/LAVA_R1/overlay
PRODUCT_PACKAGE_OVERLAYS += device/lenovo/P1m/overlay

LOCAL_PATH := device/lenovo/P1m

ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/Lava/LAVA_R1/kernel
else
